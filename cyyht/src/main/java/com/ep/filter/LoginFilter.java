...
public class LoginFilter implements Filter {
	...
	//不过滤
	public String logonStrings ="index.html;index1.html;/admin/;/user/;/userInfo/;/file/;"
			+ "/department/;/specialize/;/visitUser/;/hospital/;/doctor/;"
			+ "/account/;/positional/;/specialize/;/community/;/subscribe/;";
	//过滤
	public String includeStrings=".action;.jsp;.html;/know/;/questionAnswer/;/logs/";
	public LoginFilter() {
