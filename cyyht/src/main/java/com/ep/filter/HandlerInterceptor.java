...
public class HandlerInterceptor implements org.springframework.web.servlet.HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,Object handler) throws Exception {
        ...
        String url=request.getRequestURI();  
      //不过滤
      String logonStrings ="/css/;/images/;/lib/;/js/;/index.html;/index1.html;/admin/login.js;/sjgl/;/indexManager.html;"
    			+ "/sjgl.html;/cspz.html;";
    			
    	//过滤
        String includeStrings ="/user/;/wordExpansion/;/admin/;/individualWord/;/hfw/;/praise/;/record/;/template/";
