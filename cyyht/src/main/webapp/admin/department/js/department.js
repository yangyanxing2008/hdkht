            ...
            if(data.code ==1){
                ...
                if(data.data.length >0){
                    ...
                    for ( var i = 0; i < lists.length; i++) {
                        ...
                        var td8=$("<td height='44' align='center'><button class='custom-btn btn-2' onclick='updateshow("+lists[i].id+");' style='width: 100px;'>编辑</button>" +
                            "<button onclick='deleteDepartment("+lists[i].id+")' class='custom-btn btn-2' style='width:100px;margin-left: 2px;background: linear-gradient( 0deg, rgba(96,9,240,1) 0%, rgb(240 5 16) 100%);'>删除</button>" +
                            "<button class='custom-btn btn-2' onclick='checkd("+lists[i].id+");' " +
                            "style='margin-left: 2px;width: 140px;'>查看二级科室</button></td>");
